...
SQL_MAPPING = {
    ...
    "Formula": {
        ...
        "dbt": "SELECT *, {expression} AS {new_field}",
    ...
    "Multi-Field Formula": {
        ...
        "dbt": "SELECT *, {expression} AS {field1}, ...",
    ...
    "Join": {
        ...
        "dbt": "{join_type} JOIN {{ ref('model') }} ON {condition}",
    ...
    "Cross Tab": {
        ...
        "dbt": "SUM(CASE WHEN category = 'X' THEN value END) AS x_total",
    ...
    "Unique": {
        ...
        "dbt": "SELECT DISTINCT ... or ROW_NUMBER() window function",
    ...
    "Running Total": {
        ...
        "dbt": "SUM(column) OVER (ORDER BY ... ROWS UNBOUNDED PRECEDING)",
    ...
    "RegEx": {
        ...
        "dbt": "REGEXP_EXTRACT(column, pattern)",
    ...
    "Text To Columns": {
        ...
        "dbt": "CROSS JOIN UNNEST(SPLIT(column, delimiter))",
    ...
    "Data Cleansing": {
        ...
        "dbt": "TRIM(column), COALESCE(column, default)",
    ...
    "Find Replace": {
        ...
        "dbt": "REPLACE(column, search, replace)",
